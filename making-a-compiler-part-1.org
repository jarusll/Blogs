#+title: Making a compiler - Part 1 - Grammer & Primitive Data
#+date: 2022-06-15 
#+draft: false
#+filetags: solution
...
- What does it look like?
  - A square function in lambda calculus applied to argument =7=
...
- What are Primitive types?
  - They are basic types which can be composed to build complex types
...
- How can we match multiple digits? 
  - By using recursion. =|= represents alternation
